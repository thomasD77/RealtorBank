...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $specifics = [
            ...
            [ 'Haard', '', RoomKey::LivingRoom],
            [ 'Sierschouw', '', RoomKey::LivingRoom],
            [ 'Thermostaat', '', RoomKey::LivingRoom],

            [ 'Keukenmeubilair', '', RoomKey::Kitchen],
            [ 'Werkblad', '', RoomKey::Kitchen],
            [ 'Gootsteen', '', RoomKey::Kitchen],
            [ 'Spatwand', '', RoomKey::Kitchen],
            [ 'Buitendeur', '', RoomKey::Kitchen],
            [ 'Afzuigkap', '', RoomKey::Kitchen],
            [ 'Kookplaat', '', RoomKey::Kitchen],
            [ 'Oven', '', RoomKey::Kitchen],
            [ 'Koelkast', '', RoomKey::Kitchen],
            [ 'Vaatwasser', '', RoomKey::Kitchen],

            [ 'Wandrek', '', RoomKey::Storage],
            [ 'Afvoerpunt', '', RoomKey::Storage],
            [ 'Gootsteen', '', RoomKey::Storage],
            [ 'Kraanwerk', '', RoomKey::Storage],
            [ 'Buitendeur', '', RoomKey::Storage],
