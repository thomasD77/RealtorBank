    ...
    <li>
        ...
        >
            <ul>
                ...
                >
                    <i class="fa fa-folder"></i>{{ __('Kelder') }}
                </a>
                <div class="collapse @if($basement == $activeCat) show @endif"
                     wire:ignore.self
                     id="collapseBasement"
                >
...
{{--                <a href=""><i class="fa fa-bookmark mx-2"></i>{{ __('Gelijkvloers') }}</a>--}}
{{--                @foreach($groundFloor as $room)--}}
{{--                        <li class="mx-2">--}}
{{--                            <a data-toggle="collapse"--}}
{{--                               href="#collapseRoom{{ $room->id }}"--}}
{{--                               role="button" aria-expanded="false"--}}
